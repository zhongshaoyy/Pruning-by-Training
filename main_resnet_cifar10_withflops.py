...
parser.add_argument('--results_dir', metavar='RESULTS_DIR', default='/home/tgz/results/ResNet',
                    help='results dir')
...
def main():
    ...
    params = [
        {'params': bnan_params, 'lr': args.lr*6e-2},
    ...
    lamda_fin = 1.0
    lamda = lamda_start
    lamda_decay = (lamda_fin/lamda_start)**(1./(0.25*args.epochs))
    ...
    if args.dataset == 'imagenet':
        ...
        print_model_param_flops(model.cuda(), [32, 32])
        print_model_param_flops(pruned_model.cuda(), [32, 32])
