...
######### model config #########
################################
parser.add_argument('--dataset', metavar='DATASET', default='imagenet',  #10
...
parser.add_argument('--depth', type=int, default=18, #34,  #50,  #101,
                    help='resnet depth')
...
parser.add_argument('--momentum', default=0.9, type=float, metavar='M',
                    help='momentum')
parser.add_argument('--weight-decay', '--wd', default=1e-4, type=float,  # 5e-4
...
def main():
    ...
    if args.evaluate:
        ...
        save_checkpoint({
            'model': args.model,
            'state_dict': model.module.state_dict(),  # 包含了org数据
            'prec1': val_prec1,
